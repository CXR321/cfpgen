...
class ESMFoldStructureDecoder(nn.Module):
    def __init__(self, esmfold_config=None, **kwargs):
        ...
        self.esm, self.esm_dict = esm.pretrained.load_model_and_alphabet("/AIRvePFS/dair/chenxr-data/repo/dplm/checkpoints/struct_lfq/esm2_t6_8M_UR50D_500K.pt")
        # _, self.esm_dict = esm.pretrained.esm2_t6_8M_UR50D
        # del self.esm
