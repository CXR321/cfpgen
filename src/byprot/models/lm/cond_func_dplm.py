...
class ConditionalDPLMConfig:
    ...
    cond_setting: str = 'seq'

@register_model('cond_func_dplm')
class FuncConditionalDPLM(nn.Module):
    ...
    def forward(self, batch, weighting='linear', return_outputs=True, output_encoder_logits=False, **kwargs):
        ...
        return logits, target, loss_mask, weight, encoder_logits.repeat(2, 1, 1) if self.output_encoder_logits else None
