...
from byprot.datamodules.dataset.uniprotKB_if import UniProtKBInvFold
from byprot.datamodules.dataset.data_utils import Alphabet, MaxTokensBatchSampler

log = utils.get_logger(__name__)

@register_datamodule('uniprotKB_if')
class UniProtKBInvFoldDataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        if stage == 'fit':
            (train, valid), alphabet = UniProtKBInvFold(
            ...
            test, alphabet = UniProtKBInvFold(
                self.hparams.data_dir,
