    ...
    def on_predict_epoch_end(self) -> None:
        ...
        if self.stage == "fit":
            ...
            self.save_prediction(
                self.test_step_outputs, saveto=f"./test_tau{self.hparams.generator.temperature}_{self.hparams.generator.run_name}.fasta"
            )
            with open(f"./{self.hparams.generator.run_name}_result.txt", 'w') as f:
                f.write(f'acc: {acc}')
